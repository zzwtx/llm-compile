...
import sys
# Ensure examples/ is on sys.path so we import the repository's utils.py
sys.path.append(os.path.join(os.path.dirname(__file__), "tensorrt-llm-examples", "examples"))
